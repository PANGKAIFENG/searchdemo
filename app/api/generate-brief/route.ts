...
- pattern_suggestions 中 prompt 字段必须为英文，用于 AI 图片生成
  ...
  "pattern_suggestions": [
    {
      ...
      "prompt": "English prompt for image generation: a decorative textile pattern for school uniform front placket, incorporating [specific cultural elements from the school], embroidery style, symmetrical composition, on fabric texture, flat design, isolated on white background, high detail, 4K",
      "image_index": 0
    },
    {
      "position": "袖口",
...
- prompt 要具体描述纹样的视觉特征、文化元素，不要只写通用描述`
